...
- **Spirit note:** observe over polish — track pedigree now, let stratum families (L1–L2 / L3–L4 / Lα) **emerge** from convergence rather than pre-carving the taxonomy. See banger [Convergent skills](./LESSONS_AND_BANGERS.md#convergent-skills--2026-06-17).
