    ...
    <main className="app-shell">
      <header className="hero">
        <div>
          ...
          <p>
            Two focused React Flow prototypes grounded in the Jack drone privacy case. They use real
            Doppl mutagen agenomes and show how metabolism, criticism, selection, and held-out
      ...
      <FlowPrototype key={tab} kind={tab} />
    </main>
  );
}
